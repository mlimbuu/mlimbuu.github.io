...
My research studies multi-agent decision-making under uncertainty induced by adversarial environments, with a focus on team coordination, cooperation, and role allocation. I am interested in how teams of goal-driven agents can reason about such uncertainty, anticipate future conditions, and coordinate their actions effectively when the environment is non-stationary and partially unpredictable. My research is motivated by safety-critical applications including robot teams, autonomous navigation, and defense-oriented coordination problems, where agents must cooperate reliably despite uncertainty where robustness and interpretability matter as much as team performance.
